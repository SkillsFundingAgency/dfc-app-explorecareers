...
namespace DFC.App.ExploreCareers.IntegrationTests.ControllerTests.HealthControllerTests
{
    [Trait("Category", "Integration")]
    public class HealthControllerRouteTests : IClassFixture<CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup>>
    {
        private readonly CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup> factory;

        public HealthControllerRouteTests(CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup> factory)
        {
