...
namespace DFC.App.ExploreCareers.IntegrationTests.ControllerTests
{
    ...
    {
        public const string SampleArticleName = "send-us-a-letter";
        ...
        public static void SeedDefaultArticles(CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup> factory)
        {
            ...
            {
                eventGridEventData.Api = "https://localhost:44354/home/item/sample/" + eventGridEventData.ItemId;
