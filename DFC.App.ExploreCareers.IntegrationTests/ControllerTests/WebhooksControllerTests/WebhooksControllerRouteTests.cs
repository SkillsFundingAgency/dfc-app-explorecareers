...
namespace DFC.App.ExploreCareers.IntegrationTests.ControllerTests.WebhooksControllerTests
{
    [Trait("Category", "Integration")]
    public class WebhooksControllerRouteTests : IClassFixture<CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup>>
    {
        private const string EventTypePublished = "published";
        private const string WebhookApiUrl = "/api/webhook/ReceiveEvents";

        private readonly CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup> factory;

        public WebhooksControllerRouteTests(CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup> factory)
        {
        ...
        private static EventGridEvent[] BuildValidEventGridEvent<TModel>(string eventType, TModel data)
        {
            var models = new EventGridEvent[]
            {
                new EventGridEvent
                {
                    ...
                    Subject = "sample/an-integration-test-name",
                    Data = data,
                    EventType = eventType,
