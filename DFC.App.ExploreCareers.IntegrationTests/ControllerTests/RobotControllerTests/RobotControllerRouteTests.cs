...
namespace DFC.App.ExploreCareers.IntegrationTests.ControllerTests.RobotControllerTests
{
    [Trait("Category", "Integration")]
    public class RobotControllerRouteTests : IClassFixture<CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup>>
    {
        private readonly CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup> factory;

        public RobotControllerRouteTests(CustomWebApplicationFactory<DFC.App.ExploreCareers.Startup> factory)
        {
