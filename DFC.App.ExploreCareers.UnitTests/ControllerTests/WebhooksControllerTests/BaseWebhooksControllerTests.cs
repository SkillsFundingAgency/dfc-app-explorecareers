...
namespace DFC.App.ExploreCareers.UnitTests.ControllerTests.WebhooksControllerTests
{
    public abstract class BaseWebhooksControllerTests
    {
        ...
        protected const string ContentTypeSample = "sample";
        ...
        protected static EventGridEvent[] BuildValidEventGridEvent<TModel>(string eventType, TModel data)
        {
            var models = new EventGridEvent[]
            {
                new EventGridEvent
                {
                    ...
                    Subject = $"{ContentTypeSample}/a-canonical-name",
                    Data = data,
                    EventType = eventType,
